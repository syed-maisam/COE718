...
int mp3_player (void)
{
  ...
  LPC_TIM0->TCR = 1;					/* TC0 Enable */
	...
	GLCD_Bitmap (0, 70, 320, 92, (unsigned char *)MUSIC_WAVES_pixel_data);							
	GLCD_DisplayString(0, 0, __FI, "  USE POTENTIOMETER ");							
	GLCD_DisplayString(1, 0, __FI, "  TO ADJUST VOLUME  ");								
	GLCD_DisplayString(8, 0, __FI, "  NOW PLAYING AUDIO ");		
